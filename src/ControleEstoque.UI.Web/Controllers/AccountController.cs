...
using ControleEstoque.Infra.CrossCutting.Identity.Extensions;
using ControleEstoque.Infra.CrossCutting.Identity.Models;
using ControleEstoque.Infra.CrossCutting.Identity.Models.AccountViewModels;
using ControleEstoque.Infra.CrossCutting.Identity.Services;
using ControleEstoque.UI.Web.Extensions;
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddClaimAsync(user, new Claim("Product", "Write"));
